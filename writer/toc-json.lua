...
function Doc(body, metadata, variables)
  ...
  local json =  table.concat(buffer,'\n') .. '\n'
  -- local cleanJson, corrections = string.gsub(json, ",(%s*?[}]])", "")
  local json, corrections = string.gsub(json, ",%s[%]]", "]")
  print(corrections)
  json, corrections = string.gsub(json, ",\n$", "")
  print(corrections)
  return json
end
...
function Link(s, tgt, tit, attr)
  local title = string.gsub(s, "\n", " ")
  return '{ "href":"' .. escape(tgt,true) .. '"' .. ',"title":"' .. title .. '"},'
end
